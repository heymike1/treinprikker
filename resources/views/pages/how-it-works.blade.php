        ...
        <div class="grid gap-10 lg:grid-cols-[minmax(0,1fr)_380px] lg:gap-12">
            ...
            <div class="flex flex-col gap-5">
                ...
                <section class="card p-5">
                    ...
                    <p class="text-sm text-muted">De score loopt vloeiend af met de afstand tot het dichtstbijzijnde perron of stationsgebouw. Een prik op het station is 1000 punten.</p>
